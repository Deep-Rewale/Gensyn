...
show_header() {
    ...
    echo "| $$\  $ | $$| $$  | $$| $$  | $$| $$            | $$  \ $$    | $$          | $$  | $$| $$      | $$      | $$      "
    echo "| $$ \/  | $$| $$  | $$| $$$$$$$/| $$$$$$$$      | $$$$$$$/    | $$          | $$$$$$$/| $$$$$$$$| $$$$$$$$| $$      "
    echo "|__/     |__/|__/  |__/|_______/ |________/      |_______/     |__/          |_______/ |________/|________/|__/      "                                                                                                                    "


    echo -e "${YELLOW}           🚀 Gensyn RL-Swarm Launcher by Deep 🚀${NC}"
    echo -e "${YELLOW}              GitHub:  https://github.com/deep2882004?tab=repositories${NC}"
...
run_fixall() {
    ...
    if curl -fsSL https://raw.githubusercontent.com/deep2882004/Gensyn/new/main/fixall.sh | bash >/dev/null 2>&1; then
...
main_menu() {
    while true; do
        ...
        echo "4. 🗑️  Delete Everything & Start New"
        echo "5. ❌ Exit"
        echo -e "${GREEN}===============================================================================${NC}"
